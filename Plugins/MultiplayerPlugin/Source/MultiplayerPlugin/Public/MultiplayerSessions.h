...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FMultiplayerOnFindSessionCompleteBP,const TArray<FMySessionResult>&, SessionResults, bool, bWasSuccessful);
...
public:
    ...
    */
     ...
     */
    UFUNCTION(BlueprintCallable, Category="Multiplayer")
    void FindSessions(APlayerController* PlayerController, int32 MaxSearchResults, const FString& MatchType);
    ...
    */
	...
	UPROPERTY(BlueprintAssignable, Category="Multiplayer")
	FMultiplayerOnFindSessionCompleteBP MultiplayerOnFindSessionCompleteBP;
